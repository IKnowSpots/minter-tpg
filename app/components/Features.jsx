  ...
  return (
    <section>
      <div>
        ...
        <div>
          <h1 className="feature-h1 font-extrabold">Explore the Solutions</h1>
        ...
        <div className="features-content">
            ...
            <div>
              ...
              <a href="#0" className="features-a">
                <div>
                  ...
                  <div className="features-a-text">
                  The landing page can be customized by the event organizer to reflect the event&apos; theme, design, and promotional material.
          ...
          {/* Right Part */}
          <div>
            <img src="/Desktop.png" alt="Features section" className="features-img" />
          </div>
        </div>
      </div>
    </section>
